...
class AppLogin extends HTMLElement {
	...
	render() {
      ...
      <section id='container'>
        ...
        <section id='login-form-container'></section>
        </section>
			</section>
        `;

			const LoginFormContainer = this.shadowRoot.getElementById('login-form-container');
			LoginFormContainer.appendChild(new components.LoginForm());
