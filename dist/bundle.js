(() => {
	...
	var t = {
			51: (t, n, e) => {
				...
				s.push([
					t.id,
					'.artistContainer {\n\tdisplay: flex;\n}\n\n.artistPost {\n\tdisplay: flex;\n\tflex-direction: column;\n\tmargin-left: 11px;\n\tmargin-right: 10px;\n\tflex: 0 0 auto; /* Permitir que los posts tengan un ancho flexible */\n}\n\nsection {\n\tdisplay: flex;\n\tbackground: linear-gradient(rgb(255, 255, 255), #76767632);\n\tborder-radius: 70px;\n\tbox-shadow: 0 0 10px rgba(0, 0, 0, 0.2);\n\tmargin-bottom: 50px;\n\tmargin-top: 50px;\n\tpadding: 20px;\n\twidth: 500px;\n}\n\n.artistPost > div {\n\tmargin-right: 20px;\n}\n\n.artistPost > div img {\n\twidth: 70px;\n\theight: 70px;\n\tmargin-right: 15px;\n\tobject-fit: cover;\n\tborder-radius: 50%;\n}\n\n.artistPost > div h1 {\n\tfont-size: 20px;\n\tmargin: 5px 0 10px; /* Ajustar el margen inferior */\n}\n\n.artistPost > div p {\n\tmargin: 1px 0;\n}\n\n.artistPost:last-child {\n\tflex-grow: 1;\n\tmargin-bottom: 5px;\n}\n\n.profile {\n\tdisplay: flex;\n\tflex-direction: row;\n}\n\n.infoProfile {\n\tdisplay: flex;\n\tflex-direction: column;\n}\n\n.infoPost {\n\tmargin-top: 10px;\n\tmargin-left: 10px;\n\tmargin-bottom: 18px; /* Agregar un margen inferior de 25px */\n}\n\n#titlepost {\n\tmargin-bottom: 5px;\n}\n',
					'',
				]);
				const r = s;
			},
			...
			535: (t, n, e) => {
				...
				s.push([
					t.id,
					'.bandComponent {\n\tposition: sticky;\n\ttop: 20px;\n\tdisplay: flex;\n\tflex-direction: column;\n\talign-items: center;\n\tjustify-content: center;\n\t/* padding: 20px; */\n\tbackground: #ac084d;\n\tborder-radius: 37px;\n\tcolor: white;\n\tmax-width: 400px;\n\tmax-height: 800px;\n\tmargin-top: 100px;\n\tmargin-left: 30px;\n\tpadding-top: 0;\n}\n\n.bandImg {\n\twidth: 101%;\n\tmargin-top: 0%;\n\tmax-width: 430px;\n\tmargin-right: 0%;\n\tposition: relative;\n\topacity: 56%;\n}\n\n.textContainer {\n\twidth: 100%;\n\theight: 100px;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center; /* Centra el contenido horizontalmente */\n}\n\n.text {\n\tfont-size: 20px;\n\tmargin: -5px 0 0 0; /* Ajusta el margen superior para subir el texto */\n}\n\n.moreAbout {\n\tfont-size: 15px;\n\tmargin: -50px 0 0 0; /* Ajusta el margen superior para subir el texto */\n\tmargin-bottom: 0; /* Elimina el margen inferior */\n\tdisplay: flex;\n\talign-items: center;\n}\n',
					'',
				]);
				const r = s;
			},
			691: (t, n, e) => {
				...
				s.push([
					t.id,
					".profileImg {\n\twidth: 50px;\n\theight: 50px;\n\tborder-radius: 35%; /* Para hacer la imagen redonda */\n\tmargin-right: 15px;\n}\n\n.imagePost {\n\twidth: 140px; /* Ancho fijo para la imagen */\n\theight: auto; /* Altura automática para mantener la proporción */\n\tborder-top-left-radius: 50px; /* Borde redondo en la esquina superior izquierda */\n\tborder-bottom-left-radius: 50px; /* Borde redondo en la esquina inferior izquierda */\n}\n\n.userPostProfile {\n\tdisplay: flex;\n\talign-items: center;\n\tbackground-color: transparent; /* Fondo transparente */\n}\n\n#userPostProfile img {\n\tborder-radius: 50%;\n}\n\n.userPostComponent {\n\tdisplay: flex;\n\tflex-direction: column;\n\tborder-radius: 3 5px;\n\tbox-shadow: 0 0 10px rgba(0, 0, 0, 0.1);\n\tmargin-bottom: 50px;\n}\n\n.userPost {\n\tdisplay: flex;\n\tmargin-top: 0px;\n\tmargin-bottom: 0;\n\tpadding: 0px;\n\tborder: 0;\n}\n\n.userPostProfileInfo {\n\tflex-grow: 1;\n\tcolor: rgb(255, 255, 255);\n}\n\n.PostInfo {\n\tdisplay: flex;\n\tflex-direction: column;\n\tbackground-color: rgb(212, 212, 212); /* Fondo blanco */\n\tborder-radius: 0 35px 35px 0; /* Bordes redondos solo en la esquina superior derecha e inferior derecha */\n\tpadding: 15px; /* Espacio interno */\n\tmax-width: 800px; /* Ancho máximo */\n\toverflow: auto; /* Mostrar barras de desplazamiento si el contenido excede el ancho máximo */\n}\n\n.PostInfo .Inner {\n\tdisplay: flex;\n\talign-items: center;\n}\n\n.PostInfo .imagePost {\n\tmargin-right: 0; /* Para que la imagen del post esté pegada al margen izquierdo */\n}\n\n.heart-outline {\n\tcolor: rgb(167, 43, 6);\n\tfont-size: 25px;\n}\n\n.up {\n\tdisplay: flex;\n\tflex-direction: row;\n}\n\n.language-outline {\n\tmargin-left: auto;\n\tfont-size: 20px;\n}\n\n.name {\n\tmargin-bottom: 5px;\n\tfont-size: 18px;\n}\n\n.username {\n\tmargin-top: 0px;\n\tfont-size: 12px;\n\tfont-family: 'Red Hat Display', sans-serif;\n\topacity: 50%;\n}\n\n.chatbubble-ellipses-outline {\n\tfont-size: 22px;\n\tmargin-left: 5px;\n}\n\n.braah-one-regular {\n\tfont-family: 'Braah One', sans-serif;\n\tfont-weight: 400;\n\tfont-style: normal;\n}\n\n.red-hat {\n\tfont-family: 'Red Hat Display', sans-serif;\n\tfont-optical-sizing: auto;\n\tfont-weight: 300;\n\tfont-style: normal;\n}\n\n.linepost {\n\tpadding: 0;\n\tborder: 0;\n\tmargin-bottom: 0;\n}\n\nhr {\n\twidth: 880px;\n\tmargin-left: 5px;\n\tmargin-right: 0;\n\tmargin-top: 0;\n\tmargin-bottom: 0;\n\topacity: 50%;\n}\n\n.title {\n\tmargin-bottom: 0;\n\tfont-size: 15px;\n}\n\n.text {\n\tfont-size: 15px;\n\tmargin-top: 10px;\n}\n",
					'',
				]);
				const r = s;
			},
		...
		(() => {
			...
			class o extends HTMLElement {
				...
				render() {
					...
					i.classList.add('userPostComponent');
					const a = document.createElement('div');
					(a.id = 'userPostProfile'), a.classList.add('userPostProfile');
					const s = document.createElement('img');
					s.classList.add('profileImg'), (s.src = this.image || '');
					const r = document.createElement('div');
					r.classList.add('userPostProfileInfo');
					const d = document.createElement('h4');
					(d.textContent = this.name || ''), d.classList.add('name');
					const l = document.createElement('strong'),
						c = document.createElement('h6');
					c.classList.add('username'),
						(c.textContent = `@${this.username}` || ''),
						l.appendChild(c),
						r.appendChild(d),
						r.appendChild(l),
						a.appendChild(s),
					...
					m.classList.add('userPost');
					const p = document.createElement('img');
					p.classList.add('imagePost'), (p.src = this.imagepost || '');
					const h = document.createElement('div');
					h.classList.add('Inner');
					const u = document.createElement('div');
					u.classList.add('PostInfo');
					const g = document.createElement('p');
					(g.textContent = this.infopost || ''), g.classList.add('text');
					const f = document.createElement('div');
					f.classList.add('up');
					const b = document.createElement('h5');
					(b.textContent = this.titlepost || ''), b.classList.add('title');
					const w = document.createElement('ion-icon');
					w.setAttribute('name', 'language-outline'),
						w.classList.add('language-outline'),
						f.appendChild(b),
						f.appendChild(w);
					const x = document.createElement('div');
					x.classList.add('buttons');
					const y = document.createElement('ion-icon');
					y.classList.add('heart-outline'), y.setAttribute('name', 'heart-outline');
					const v = document.createElement('ion-icon');
					v.setAttribute('name', 'chatbubble-ellipses-outline'),
						v.classList.add('chatbubble-ellipses-outline'),
						u.appendChild(f),
						u.appendChild(g),
						u.appendChild(x),
						x.appendChild(y),
					...
					P.classList.add('linepost');
					const A = document.createElement('hr');
					P.appendChild(A), null === (e = this.shadowRoot) || void 0 === e || e.appendChild(P);
					const C = this.ownerDocument.createElement('style');
					(C.innerHTML = n.A),
						null === (o = this.shadowRoot) || void 0 === o || o.appendChild(C),
						y.addEventListener('click', () => {
							'heart' == y.getAttribute('name')
								? y.setAttribute('name', 'heart-outline')
								: y.setAttribute('name', 'heart');
						});
				}
			}
			...
			class s extends HTMLElement {
				...
				render() {
					...
					(n.innerHTML = a.A), null === (t = this.shadowRoot) || void 0 === t || t.appendChild(n);
				}
			}
			customElements.define('artist-post', s);
			var r,
				d = e(535);
			!(function (t) {
			...
			class l extends HTMLElement {
				...
				attributeChangedCallback(t, n, e) {
					null !== e && (t === r.uid ? (this[t] = parseInt(e)) : (this[t] = e)), this.render();
				}
				constructor() {
					super(), this.attachShadow({ mode: 'open' });
				}
				...
				render() {
					...
					const n = this.ownerDocument.createElement('style');
					(n.innerHTML = d.A), null === (t = this.shadowRoot) || void 0 === t || t.appendChild(n);
				}
			}
			...
			class m extends HTMLElement {
				...
				render() {
					...
					const n = this.ownerDocument.createElement('style');
					(n.innerHTML = c.A), null === (t = this.shadowRoot) || void 0 === t || t.appendChild(n);
				}
			}
			...
			class u extends HTMLElement {
				...
				render() {
					...
					const n = this.ownerDocument.createElement('style');
					(n.innerHTML = h.A), null === (t = this.shadowRoot) || void 0 === t || t.appendChild(n);
				}
			}
			...
			class w extends HTMLElement {
				...
				attributeChangedCallback(t, n, e) {
					null !== e && (t === f.uid ? (this[t] = parseInt(e)) : (this[t] = e)), this.render();
				}
				constructor() {
					super(), this.attachShadow({ mode: 'open' });
				}
				...
				render() {
					...
					const n = this.ownerDocument.createElement('style');
					(n.innerHTML = b.A), null === (t = this.shadowRoot) || void 0 === t || t.appendChild(n);
				}
			}
			...
			const x = [
					...
					},
					{
						...
						post1: {
							titlePost: '⚡',
							infoPost:
								'This has been a long time coming. Can’t wait to welcome you all to the world of Electric Century!⚡',
							imagePost: 'https://www.sopitas.com/wp-content/uploads/2020/04/my-chemical-romance-destacada.jpg',
						},
					},
					{
			...
			class P extends HTMLElement {
				constructor() {
					super(),
						...
						x
							...
							.forEach((n) => {
								const e = this.ownerDocument.createElement('user-post');
								e.setAttribute(t.uid, String(n.id)),
									e.setAttribute(t.type, n.type),
									e.setAttribute(t.name, n.name),
									e.setAttribute(t.image, n.image),
									e.setAttribute(t.username, n.username),
									e.setAttribute(t.email, n.email),
									e.setAttribute(t.password, n.password),
									e.setAttribute(t.info, n.info),
									e.setAttribute(t.followers, String(n.followers)),
									e.setAttribute(t.titlePost, n.post1.titlePost),
									e.setAttribute(t.infoPost, n.post1.infoPost),
									e.setAttribute(t.imagePost, n.post1.imagePost),
									this.userpost.push(e);
							}),
						x
							.filter((t) => 'Artist' === t.type)
							.forEach((t) => {
								const n = this.ownerDocument.createElement('artist-post');
								n.setAttribute(i.uid, String(t.id)),
									n.setAttribute(i.type, t.type),
									n.setAttribute(i.name, t.name),
									n.setAttribute(i.image, t.image),
									n.setAttribute(i.username, t.username),
									n.setAttribute(i.email, t.email),
									n.setAttribute(i.password, t.password),
									n.setAttribute(i.info, t.info),
									n.setAttribute(i.followers, String(t.followers)),
									n.setAttribute(i.titlePost, t.post1.titlePost),
									n.setAttribute(i.infoPost, t.post1.infoPost),
									n.setAttribute(i.imagePost, t.post1.imagePost),
									this.artistpost.push(n);
							});
					const n = y.find((t) => 1 === t.id);
					if (n) {
						const t = this.ownerDocument.createElement('more-about');
						t.setAttribute(r.uid, String(n.id)),
							t.setAttribute(r.bandName, n.bandName),
							t.setAttribute(r.bandImage, n.bandImage),
							this.moreabout.push(t);
					}
					const e = x.find((t) => 1 === t.id);
					if (e) {
						const t = this.ownerDocument.createElement('create-post');
						t.setAttribute(f.uid, String(e.id)),
							t.setAttribute(f.image, e.image),
							t.setAttribute(f.type, e.type),
							this.createpost.push(t);
					}
				}
				connectedCallback() {
					this.render(), this.setupScrollHandlers();
				}
				setupScrollHandlers() {
					if (this.shadowRoot) {
						const t = this.shadowRoot.getElementById('chevron-back-outline'),
							n = this.shadowRoot.getElementById('chevron-forward-outline'),
							e = this.shadowRoot.getElementById('artist-posts-section');
						null == t ||
							t.addEventListener('click', () => {
								null == e || e.scrollBy({ left: -500, behavior: 'smooth' });
							}),
							null == n ||
				...
				render() {
					...
					if (this.shadowRoot) {
						...
						const n = this.shadowRoot.getElementById('artist-posts-section'),
							e = this.shadowRoot.getElementById('user-posts-section'),
							o = this.shadowRoot.getElementById('more-about-section'),
							i = this.shadowRoot.getElementById('create-post-section');
						...
						(a.innerHTML = v.A), null === (t = this.shadowRoot) || void 0 === t || t.appendChild(a);
					}
				}
			}
