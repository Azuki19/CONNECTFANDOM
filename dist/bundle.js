(() => {
	...
	var t = {
			...
			535: (t, e, n) => {
				...
				s.push([
					t.id,
					'.bandImg {\n\twidth: 70px;\n\theight: 70px;\n}\n\n.bandComponent {\n\twidth: 500px;\n\theight: 200px;\n}\n\n* {\n\tbackground-color: rgb(134, 20, 41);\n}\n',
					'',
				]);
				const r = s;
			},
		...
		(() => {
			...
			class i extends HTMLElement {
				...
				render() {
					...
					n.classList.add('userPostComponent');
					const i = document.createElement('div');
					(i.id = 'userPostProfile'), i.classList.add('userPostProfile');
					const o = document.createElement('img');
					o.classList.add('profileImg'), (o.src = this.image);
					const a = document.createElement('div');
					a.classList.add('userPostProfileInfo');
					const s = document.createElement('h4');
					s.textContent = this.name;
					const r = document.createElement('strong'),
						d = document.createElement('h6');
					(d.textContent = this.username),
						r.appendChild(d),
						a.appendChild(s),
						a.appendChild(r),
						i.appendChild(o),
					...
					c.classList.add('userPost');
					const l = document.createElement('img');
					l.classList.add('imagePost'), (l.id = 'imagePost'), (l.src = this.imagepost);
					...
					h.textContent = this.titlepost;
					const g = document.createElement('ion-icon');
					g.classList.add('language-outline'),
						g.setAttribute('name', 'language-outline'),
						u.appendChild(h),
						u.appendChild(g),
						p.appendChild(u);
					const f = document.createElement('p');
					f.textContent = this.infopost;
					const b = document.createElement('div');
					b.classList.add('buttons');
					const w = document.createElement('ion-icon');
					w.classList.add('heart-outline'), w.setAttribute('name', 'heart-outline');
					const x = document.createElement('ion-icon');
					x.setAttribute('name', 'chatbubble-ellipses-outline'),
						b.appendChild(w),
						b.appendChild(x),
						p.appendChild(f),
						p.appendChild(b),
					...
					const v = this.ownerDocument.createElement('style');
					(v.innerHTML = e.A),
						null === (t = this.shadowRoot) || void 0 === t || t.appendChild(v),
						w.addEventListener('click', () => {
							'heart' == w.getAttribute('name')
								? w.setAttribute('name', 'heart-outline')
								: w.setAttribute('name', 'heart');
						});
				}
			}
			customElements.define('user-post', i);
			var o,
				a = n(51);
			!(function (t) {
				(t.uid = 'uid'),
			...
			customElements.define('main-header', h);
			const g = h;
			var f,
				b = n(181);
			!(function (t) {
					...
					super(),
						...
						x
							...
							.forEach((t) => {
								...
								e.setAttribute(o.uid, String(t.id)),
									e.setAttribute(o.type, t.type),
									e.setAttribute(o.name, t.name),
									e.setAttribute(o.image, t.image),
									e.setAttribute(o.username, t.username),
									e.setAttribute(o.email, t.email),
									e.setAttribute(o.password, t.password),
									e.setAttribute(o.info, t.info),
									e.setAttribute(o.followers, String(t.followers)),
									e.setAttribute(o.titlePost, t.post1.titlePost),
									e.setAttribute(o.infoPost, t.post1.infoPost),
									e.setAttribute(o.imagePost, t.post1.imagePost),
									this.artistpost.push(e);
							});
					const e = v.find((t) => 1 === t.id);
					if (e) {
				...
				render() {
					...
					if (this.shadowRoot) {
						...
						const e = this.shadowRoot.getElementById('artist-posts-section'),
							...
							i = this.shadowRoot.getElementById('more-about-section'),
							o = this.shadowRoot.getElementById('create-post-section');
						...
						(a.innerHTML = y.A), null === (t = this.shadowRoot) || void 0 === t || t.appendChild(a);
					}
				}
			}
