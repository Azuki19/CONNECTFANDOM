		...
		(() => {
			...
			class a extends HTMLElement {
				...
				render() {
					...
					(e.innerHTML = s.A), null === (t = this.shadowRoot) || void 0 === t || t.appendChild(e);
				}
			}
			...
			class x extends HTMLElement {
				...
				render() {
					...
					if (this.shadowRoot) {
						...
						(s.innerHTML = P.A), null === (t = this.shadowRoot) || void 0 === t || t.appendChild(s);
					}
				}
			}
